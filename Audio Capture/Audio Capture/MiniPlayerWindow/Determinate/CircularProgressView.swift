...
open class CircularProgressView: DeterminateAnimation {
    ...
    override func configureLayers() {
        ...
        do {
            ...
            backgroundPath.appendArc(withCenter: NSPoint.init(x: NSMidX(rect), y: NSMidY(rect)), radius: radius, startAngle: 0, endAngle: 360)
        ...
        do {
            ...
            arcPath.appendArc(withCenter:  NSPoint.init(x: NSMidX(rect), y: NSMidY(rect)), radius: radius, startAngle: startAngle, endAngle: (startAngle - 360), clockwise: true)
